                            ...
                            <div className="filter-group">
                                ...
                                <Select value={statusFilter} onValueChange={setStatusFilter}>
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem
                                            value="published_receiving_proposals">{t('status.published_receiving_proposals')}</SelectItem>
                                        <SelectItem
                                            value="under_review">{t('status.under_review') || 'На рассмотрении'}</SelectItem>
                                ...
                                >
                                    <div className="tender-card-header">
                                        <div className="tender-meta-top">
                                            <span
                                                className="tender-id">№ {tender.tender_number || `T-${new Date(tender.created_at).getFullYear()}-${tender.id.slice(0, 4)}`}</span>
                      ...
                      {getStatusLabel(tender.status)}
                                    ...
                                    <div className="tender-card-content">
                                        ...
                                        <div className="tender-details-grid">
                                            <div className="detail-item">
                                                ...
                                                <span
                                                    className="price-highlight">{tender.budget.toLocaleString()} {tender.id === '508e1745-94d6-40ca-9bd5-1e09327ad4f8' ? `$` : '₸'}</span>
                                            </div>
                                            <div className="detail-item">
                                            ...
                                            <div className="detail-item">
                                                ...
                                                <span
                                                    className="detail-value">{getCategoryLabel(tender.category)}</span>
                                            </div>
                                            <div className="detail-item">
                                    ...
                                    <div className="tender-card-footer">
                                        <div className="tender-dates">
                                            <span
                                                className="date-label">{t('tenderDetail.deadline')}: {new Date(tender.deadline).toLocaleDateString()}</span>
                                        </div>
